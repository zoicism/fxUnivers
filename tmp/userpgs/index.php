			...
			<li class="items" >
			    <?php
                    ...
                    if(file_exists($path.$get_user_id.'.jpg')) {
                        ...
                        echo('<a class="link avatar" style="margin:auto;background-image: url(\'avatars/'.$get_user_id.'.jpeg\');"></a>');
                    } elseif(file_exists($path.$get_user_id.'.png')) {
                        echo('<a class="link avatar" style="margin:auto;background-image: url(\'avatars/'.$get_user_id.'.png\');"></a>');
                    } elseif(file_exists($path.$get_user_id.'.gif')) {
                        echo('<a class="link avatar" style="margin:auto;background-image: url(\'avatars/'.$get_user_id.'.gif\');"></a>');
                    } else {
                        echo('<a class="link avatar" style="margin:auto;"></a>');
                    }
                ?>
...
?>
	...
	<section style="margin-bottom:50px">
		<ul class="flex-container height-50" style="height:14em">
			<li class="items">
				<a href="#" class="link">
