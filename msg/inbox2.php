          ...
          <hr class="hrtitle" style="border-color: #25252533">
			...
			<div class="c3">
                                <div class="rightsidebar">
                                        <div id="result"><h2 class="title stresstitle">Messages</h2></div>
                                        <hr class="hrtitle">
					  <table>
					  <?php while($row = $get_msg_result->fetch_assoc()) {
...
<?php
    $path="../userpgs/avatars/";
    if(file_exists($path.$guest_id.'.jpg')) {
        echo('<div class="avatarpic" style="background-image: url(\'../userpgs/avatars/'.$guest_id.'.jpg\');"></div>');
    } elseif(file_exists($path.$guest_id.'.jpeg')) {
        echo('<div class="avatarpic" style="background-image: url(\'../userpgs/avatars/'.$guest_id.'.jpeg\');"></div>');
    } elseif(file_exists($path.$guest_id.'.png')) {
        echo('<div class="avatarpic" style="background-image: url(\'../userpgs/avatars/'.$guest_id.'.png\');"></div>');
    } elseif(file_exists($path.$guest_id.'.gif')) {
        echo('<div class="avatarpic" style="background-image: url(\'../userpgs/avatars/'.$guest_id.'.gif\');"></div>');
    } else {
        echo('<div class="avatarpic avatarr"></div>');
    }
?>
                            </td>
					      <td style="width: 90%; padding-left: 20px;"><a href="<?php echo '/msg/'.$get_guest['username']?>" style="color: black"><?php echo '<strong>'.$get_guest['fname'].' '.$get_guest['lname'].'</strong> @'.$get_guest['username'].'<br><p style=" color: gray">'.$row['text'].'</p>' ?></a></td>
					    </tr>
					<?php } ?>
					</table>
                                </div>
			...
			<div class="c33" style="text-align: center">
			  <img src="/images/artwork/new_msg.png" style="display: block; margin-left: auto; margin-right: auto; width: 20%; margin-top: 50px;"/>
			  Click to start a new conversation with a friend!
...
<?php
    ...
    if(file_exists($path.$fnd_user_fetch["id"].'.jpg')) {
        echo('<div class="avatarpic" style="background-image: url(\'../userpgs/avatars/'.$fnd_user_fetch["id"].'.jpg\');"></div>');
    } elseif(file_exists($path.$fnd_user_fetch["id"].'.jpeg')) {
        echo('<div class="avatarpic" style="background-image: url(\'../userpgs/avatars/'.$fnd_user_fetch["id"].'.jpeg\');"></div>');
    } elseif(file_exists($path.$fnd_user_fetch["id"].'.png')) {
        echo('<div class="avatarpic" style="background-image: url(\'../userpgs/avatars/'.$fnd_user_fetch["id"].'.png\');"></div>');
    } elseif(file_exists($path.$fnd_user_fetch["id"].'.gif')) {
        echo('<div class="avatarpic" style="background-image: url(\'../userpgs/avatars/'.$fnd_user_fetch["id"].'.gif\');"></div>');
    } else {
        echo('<div class="avatarpic avatarr"></div>');
    }
?>
			      ...
			      <td style="width: 90%; padding-left: 20px;">
			        <a href="<?php echo '/msg/'.$fnd_user_fetch['username']?>" style="color: black">
			          <?php echo '<b>'.$fnd_user_fetch["fname"].' '.$fnd_user_fetch["lname"].'</b> @'.$fnd_user_fetch["username"]; ?>
				</a>
			      </td>
			    </tr>
			      <?php } ?>
			    <?php } else {
			      echo '<br><br><a href="/search" style="color: brown">Add a friend first!</a>';
			    } ?>
			  </table>
