  ...
  <div class="login-container">
    <div class="login-form">
      <div class="fxunivers-logo">
        ...
        <div class="fxunivers-txt">fxUnivers</div>
	  <g>
...
?>
	...
	<div class="fx-icon fxstar-icon"><span>fxStar</span><p>Purchase products/services, or send/recieve as gift. <a href="/about#fxstar">Learn more</a></p></div>
        ...
        <div class="fx-icon fxsonet-icon"><span>fxSonet</span><p style="margin-bottom: 0;">A social network of trading for traders (Coming soon for public)</p></div>
      </div>
    </div>
    
    <div class="empty-space"><div></div></div>
  </div>
