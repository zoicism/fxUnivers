...
<div class="fxinstructor-fxsubinstructor-desc">
		...
		<div class="solo-sub">
			...
			<div class="fxpartner-shares">
				<p class="fxpartner-shares-pg mobile-view-pg">Here's an example of how an fxSubCourse's fxStars will be shared among fxUnivers and users, including the fxPartner.</p>
				<div class="fxpartner-chart">
				...
				<p class="fxpartner-shares-pg desktop-view-pg">Here's an example of how an fxSubCourse's fxStars will be shared among fxUnivers and users, including the fxPartner.</p>
			 </div>	    
		    </div>
