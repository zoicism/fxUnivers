...
if(isset($_FILES['class_file'])) {
    $uploadok=1;
    $path=$_SERVER['DOCUMENT_ROOT'].'/userpgs/instructor/class/live/ooo_files/';
    ...
    if($uploadok) {
        if(move_uploaded_file($_FILES['class_file']['tmp_name'],$upfile)) {
            ...
            $upload_live_q="INSERT INTO class_files_ooo(instId, classId, fileName) VALUES($instId, $classId, '$file_name')";
