...
$select_files_q="SELECT * FROM class_files_ooo WHERE classId=$class_id";
...
if($select_file_count>0) {
    while($lifi_row=$select_file_r->fetch_assoc()) {
        echo '<div class="file">
		<div class="file-icon-con" href="dl_file_ooo.php?file=' . urlencode($lifi_row['fileName']) . '">
        ...
        echo '<div class="file-name"><div class="file-name-txt" href="dl_file_ooo.php?file=' . urlencode($lifi_row['fileName']) . '">' . substr($lifi_row['fileName'],11) . '</div></div>';
        if($user_type=='instructor') {
	    echo '<div class="download-delete-con">';
	    echo '<div class="download-file">
	    		<a target="hidden-del" href="dl_file_ooo.php?file=' . urlencode($lifi_row['fileName']) . '">
            ...
            echo '<div class="del">
	    		<a target="hidden-del" href="/php/del_live_file_ooo.php?file_name='.$lifi_row['fileName'].'">
