...
$add_online_q='UPDATE user SET lsPage="live/ooo#'.$class_id.'" , lastseen="'.$dt.'" WHERE id='.$user_id;
...
$slct_q='SELECT * FROM user WHERE id='.$student_id.' AND lsPage="live/ooo#'.$class_id.'"'; 
...
if($slct_count>0) {
    ...
    echo '<p class="gray" style="text-align:center">No one is online yet.</p>';
}
