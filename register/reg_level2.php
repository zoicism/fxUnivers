...
if(isset($_SESSION['username'])) {
	...
	$emailA = mysqli_fetch_array($result);
	$email = $emailA['email'];
}
?>
	...
	<div class="row space-bot">
		...
		<div class="c8">
			...
			<ul id="responsivemenu">
				<li class="active"><a href=""><font size="+1">SIGN IN</font><span class="showmobile">Sign Up</span></a></li>
		...
		<div class="row">		
			...
			<div class="container">
				<form class="form-signin" method="POST" action="confirm.php">
					...
					<div class="input-group">
                                                <span class="input-group-addon" id="basic-addon1">Username</span>
                                                <input type="text" name="username" class="form-control" value="<?php echo $username ?>" required readonly>
                                        </div>
					<?php } ?>
					...
					<?php } else { ?>
					<label for="inputEmail" class="sr-only">Email Address</label>
                                        <input type="email" name="email" id="inputEmail" class="form-control" value="<?php echo $email ?>" required readonly>
					<?php } ?>
					<label for="inputPhone" class="sr-only">Phone Number</label>
					<input type="text" name="phone" id="inputPhone" class="from-control" required>
					<label for="inputPassword" class="sr-only">Password</label>
					<input type="password" name="password" id="inputPassword" class="form-control" required>
					<label for="inputCheckbox" class="sr-only">Choose which plan(s) you want to register to:</label>
					<input type="checkbox" name="fxuniversity" value="yes">  fxUniversity<br>
					<input type="checkbox" name="fxuniverse" value="yes">  fxUniverse<br>
					<input type="checkbox" name="fxpartner" value="yes">  fxPartner<br>
