    ...
    <div class="intro-section" id="home-section">
      ...
      <div class="slide-1" style="background-image: url('/first/images/hero_1.png');" data-stellar-background-ratio="0.5">
		...
		<div class="col-lg-5 ml-auto">
		  ...
		  <form action="/register/instructor_reg_success.php" method="POST" class="form-box" autocomplete="off">
		    <h3 class="h4 text-black mb-4">Hi <?php echo $get_user_fname ?>!<h3>
		    <p style="color: #000">By registering as an instructor at fxUniversity, you need to agree to the following terms and conditions.</p>
		    <?php if($get_user_phone == "NA") { ?>
		    <div class="form-group">
		      <input type="text" name="phone" class="form-control" placeholder="Phone Number (required)" required>
		    </div>
		    <?php } ?>
		    <p style="color: #000; font-size: 0.80rem;">When you sign up to become an instructor on the fxUniversity platform, you agree to abide by these <a onclick="regPop()" style="cursor: pointer; color:#8bcae5;">registration terms</a>. These Terms cover details about the aspects of the fxUniversity platform relevant to instructors and are incorporated by reference into our <a onclick="policyPop()" style="cursor:pointer;color:#8bcae5;">Terms of Use</a>, the general terms that govern your use of our Services.</p>
