if(screen.width>628) {
    ...
    $('.header').html(`
        ...
        <nav>
            <ul class="nav__links">
                <li tabIndex="1" id="nav-home"><a href="/">
                ...
                <li tabIndex="1" id="nav-msg"><a href="/msg/inbox.php">
                ...
                </a><div class="newnum" id="msg-bar"></div></li>





                <li tabIndex="1" id="nav-notif"><a href="/userpgs/notif">
                ...
                <div class="newnum" id="notif-bar"></div></a></li>




                <li tabIndex="1" id="nav-search"><a href="/search">
...
$('.header').html(`
        ...
        <nav>
            <ul class="nav__links">
                <li><a  class="blur" style="visibility:hidden" onclick="goBack()"><svg aria-label="menu" viewBox="0 0 32 32">
                      <rect class="cls-1" x="3" y="3" width="26" height="2" rx="1"/><rect class="cls-1" x="3" y="15" width="26" height="2" rx="1"/><rect class="cls-1" x="3" y="27" width="26" height="2" rx="1"/>
                    </svg></a></li>
