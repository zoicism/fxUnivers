...
if(screen.width>628) {
    ...
    // Sidebar header * * * * * * > NEW: last <li> added to <ul>   +   <div id="mySidepanel" added   +   inline width and height deleted * * * * * *
    $('.header-sidebar').html(`
        <nav>
            <ul class="nav__links">
...
<a href="/" style="margin-right:auto"><img src="/images/icons/toolbar/back.png" width="22px" height="22px"></a>
    ...
    // Sidebar header  * * * * * * > NEW: class="blur" given to the first <a>   +   everything after that are added * * * * * *
    $('.header-sidebar').html(`
<a href="/" class="blur" style="margin-right:auto"><img src="../images/icons/toolbar/back.png" width="22px" height="22px"></a>
