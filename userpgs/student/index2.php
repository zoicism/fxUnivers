...
<div class="navbar">
	...
	<a href="/userpgs" class="active" href="javascript:void(0)"><img src="/images/upperbar/home.png" width="25px" height="25px" alt="Home"></a>
...
<div class="grid">
				...
				<div id="list4">
					...
					<li><a href="" style="color: #BDCFE0; background-color: #425362;">Student</a></li>
			...
			<div class="c3">
			     <div class="rightsidebar">
			     	  <h2 class="title stresstitle">My Courses</h2>
				  <hr class="hrtitle">
				  <table>
					<col width="20%">
					<col width="20%">
					...
					<td><a href="/userpgs/teacher/course_management/course.php?course_id=<?php echo $course_id ?>"><img src="/images/teacher/course.png" height="100" width="100"></a></td>
				  ...
				  ?>
					...
					<tr style="border-bottom: 1px solid black;">
					<td><a href="/userpgs/teacher/course_management/course.php?course_id=<?php echo $row['id'] ?>"><img src="/images/teacher/course.png" height="100" width="100"></a></td>
		...
		<div class="c33">
		     <img src="/images/teacher/diploma.png" width="100" height="100" class="center">
		     <p style="margin-left:6%; color: #5DADE2;">My Certificates</p>
		</div>
