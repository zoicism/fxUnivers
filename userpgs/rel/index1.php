          ...
          <hr class="hrtitle" style="border-color: #25252533">
			...
			<div class="c3">
					  ...
					  <div id="friends" class="tabcontent" style="<?php if((isset($_GET['act']) && $act=='friends')) { echo 'display: block'; } ?>">
						...
						?>
					      <tr style="border-bottom:1px solid #25252533;cursor:pointer;" onclick="window.location='/user/<?php echo $fnd_user_fetch['username'] ?>';" class="hoverable">
					        <td style="width: 10%">
<?php
    $path="../avatars/";
...
?>
						...
						<td style="width: 90%; padding-left: 20px;">
						  <?php echo '<b>'.$fnd_user_fetch["fname"].' '.$fnd_user_fetch["lname"].'</b> @'.$fnd_user_fetch["username"].'<br>'.$fnd_user_fetch["bio"]; ?>
					  	</td>
					      </tr>
					      <?php } ?>
					    <?php } ?>
					  ...
					  <div id="following" class="tabcontent" style="<?php if((isset($_GET['act']) && $act=='following')) { echo 'display: block'; } ?>">
						...
						?>
					      <tr  style="border-bottom:1px solid #25252533;cursor:pointer;" onclick="window.location='/user/<?php echo $following_user_fetch['username'] ?>';" class="hoverable">
					        <td style="width: 10%">
<?php
    $path="../avatars/";
...
?>
						...
						<td style="width: 90%; padding-left: 20px;">
						  <?php echo '<b>'.$following_user_fetch["fname"].' '.$following_user_fetch["lname"].'</b> @'.$following_user_fetch["username"].'<br>'.$following_user_fetch["bio"]; ?>
					  	</td>
					      </tr>
					      <?php } ?>
					    <?php } ?>
					  ...
					  <div id="followers" class="tabcontent" style="<?php if((isset($_GET['act']) && $act=='followers')) { echo 'display: block'; } ?>">
						...
						?>
					      <tr style="border-bottom:1px solid #25252533;cursor:pointer;" onclick="window.location='/user/<?php echo $followers_user_fetch['username'] ?>';" class="hoverable">
					        <td style="width: 10%">
<?php
    $path="../avatars/";
...
?>
						...
						<td style="width: 90%; padding-left: 20px;">
						  <?php echo '<b>'.$followers_user_fetch["fname"].' '.$followers_user_fetch["lname"].'</b> @'.$followers_user_fetch["username"].'<br>'.$followers_user_fetch["bio"]; ?>
					  	</td>
					      </tr>
					      <?php } ?>
					    <?php } ?>
