			...
			<div class="c3-1">
			     <div class="rightsidebar">
				  ...
				  <div class="container">
				       ...
				       <form class="form-signin" method="POST" action="new_post.php" enctype="multipart/form-data" autocomplete="off">
				         <h2 class="form-signin-heading"></h2>
					       ...
					       <input type="text" name="header" class="form-control" placeholder="Class subject" required autofocus>
                           <span class="input-group-addon" id="basic-addon1"><p style="font-size: 1.5rem; font-style: bold; text-indent: 0;">Description</p></span>
					       <textarea name="description" class="form-control" rows="13" placeholder="Class description"></textarea>
					     ...
					     <input type="hidden" name="course_id" value="<?php echo $course_id ?>" />
				       	   <button class="btn" type="submit" style="float:right">Next</button>
				       </form>
				  </div>
			     </div>
			</div>
