          ...
          <hr class="hrtitle" style="border-color: #25252533">
			...
			<div class="c3">
			     <div class="rightsidebar">
			     	  <h2 class="title stresstitle">Courses</h2>
				  <hr class="hrtitle">
				  <table>
					<col width="15%">
					<col width="25%">
					...
					<?php if($course_count>0) { ?>
                                                <tr style="border-bottom: 1px solid #c3c3c3;cursor:pointer;" onclick="window.location='/userpgs/instructor/course_management/course.php?course_id=<?php echo $course_id ?>';">
					<td style="vertical-align:middle;"><img src="/images/artwork/course.png" height="50" width="50"></td>
				  ...
				  ?>
					...
					<tr style="border-bottom: 1px solid #c3c3c3;cursor:pointer;" onclick="window.location='/userpgs/instructor/course_management/course.php?course_id=<?php echo $row['id'] ?>';">
					<td style="vertical-align:middle;"><img src="/images/artwork/course.png" height="50" width="50"></td>
			...
			<div class="c33">
			  <table>
			  <tr>
			    <td><a href="/userpgs/instructor/course_management/new_course.php" style="color: #000;"><img src="/images/artwork/new_course.png" style="width: 100px; height: 100px; margin-left: auto;"></a></td>
			  </tr>
			  <tr>
			    <td style="text-align: center; padding-top: 0;"><a href="/userpgs/instructor/course_management/new_course.php" style="color: #000; text-align: left;">Add a new course!</a></td>
			  </tr>
			  </td>
			  </tr>
			  </table>
