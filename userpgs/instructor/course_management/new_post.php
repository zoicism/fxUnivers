...
if(isset($_POST['header']) && isset($_POST['description'])) {
    ...
    $query = "INSERT INTO `teacher` (user_id, header, description, cost, start_date, negotiable, subbable, private) VALUES ($id, '$header', '$description', $cost, NOW(), $negotiable, $subbable, $private)";
