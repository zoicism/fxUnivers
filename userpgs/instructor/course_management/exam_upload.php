...
<div class="undermenuarea">
	...
	<div class="grid">
		<div class="row">
			<div class="c8">
				<h1 class="titlehead">Exam Upload</h1>
			</div>
			<div class="c4">
			...
			<div class="container">
				<form class="form-signin" method="POST" action="">
					...
					<div class="input-group">
						<span class="input-group-addon" id="basic-addon1">Exam Subject</span>
						<input type="text" name="header" class="form-control" required autofocus>
						<span class="input-group-addon" id="basic-addon1">Time Limit:</span>
						<input type="text" name="time_limit" class="from-control" required>
						<span class="input-group-addon" id="basic-addon1">Exam Interval, from:</span>
						<input type="date" name="from" class="from-control" required>
						<span class="input-group-addon" id="basic-addon1">to</span>
						<input type="date" name="to" class="from-control" required>
						<span class="input-group-addon" id="basic-addon1">Lockdown?</span><br>
						<input type="checkbox" name="lockdown"> Enable<br><br>
						<span class="input-group-addon" id="basic-addon1">Exam Body:</span>
						<textarea name="body" class="form-control" rows="33" required></textarea>
						<span class="input-group-addon" id="basic-addon1">Cover Image:</span>
