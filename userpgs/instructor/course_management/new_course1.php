          ...
          <hr class="hrtitle" style="border-color: #25252533">
			...
			<div class="c3-1">
			     <div class="rightsidebar">
			     	  <h2 class="title stresstitle">New Course</h2>
				  <hr class="hrtitle">
				  ...
				  <div class="container">
				       ...
				       <form class="form-signin" method="POST" action="new_post.php" autocomplete="off">
					    ...
					    <input type="text" name="header" class="form-control" placeholder="Course subject" required autofocus>
					    <span class="input-group-addon" id="basic-addon1"><p style="font-size: 1.5rem; font-style: bold; text-indent: 0;">Description</p></span>
					    <textarea name="description" class="form-control" rows="13" placeholder="Course description" required></textarea>
					    
					    
					    <span class="input-group-addon" id="basic-addon1"><p style="font-size: 1.5rem; font-style: bold; text-indent: 0;">Cost</p></span>
					    <input type="number" name="course_fxstar" class="form-control" placeholder="The cost of your course in fxStars." id="costIn" min="0" required>
