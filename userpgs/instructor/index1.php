...
<?php
                $stu1_q="SELECT id FROM teacher WHERE user_id=$get_user_id";
...
<div class="col-33 mid-col">
                <div class="col-1 pointer fxuniversity-color" onclick="location.href='/userpgs/instructor/course_management/new_course.php';">
                <h3>Add course</h3>
