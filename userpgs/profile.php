			...
			<div class="c3">
                                <div class="rightsidebar">
                                        ...
                                        <div class="teamdescription">
                                                <h1>BIO <a href="edit_profile.php">edit</a></h1>
						...
						<p>Ranking: (0/5)</p>
						<p>fxStars: 0</p>
						<p class="checkmark">fxChecks: <x>x x x</x></p>
					</div>
					<br/>
					<div class="teamdescription">
                                                <h1>PROJECTS <a href="/userpgs/teacher/upload.php"> add</a></h1>
						<!-- COURSE BOXES -->
						<div class="row space-top">
								...
								<div class="boxthreecolumns cat1">
				                                        <div class="boxcontainer">
				                                                ...
				                                                <div class="mosaic-block cover">
			                                                                <a href="/userpgs/teacher/course_management/singleproject_test.php"><img src="/images/training/billgates.jpg" alt=""></a>
				                                                </div>
				                                                <h1><a href="/userpgs/teacher/course_management/singleproject_test.php">Billie on Books</a></h1>
				                                        </div>
				                                </div>
							<!-- EO BOX 1 -->
							<?php
							...
							?>
									...
									<div class="boxthreecolumns cat1">
										<div class="boxcontainer">
											<div class="mosaic-block cover">
												<a href="/userpgs/teacher/course_management/singleproject.php?course_id=<?php echo $row["id"] ?>"><img src="<?php echo $row["img"] ?>" alt=""></a>
											</div>
											<h1><a href="/userpgs/teacher/course_management/singleproject.php?course_id=<?php echo $row["id"] ?>"><?php echo $row["header"] ?></a></h1>
										</div>
									</div>
							<?php
								}
