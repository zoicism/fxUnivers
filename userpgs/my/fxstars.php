...
<div class="grid">
			...
			<div class="c3">
                                <div class="rightsidebar">
                                        <h2 class="title stresstitle">Workspace</h2>
                                        <hr class="hrtitle">
                                        <div class="teamdescription">
                                                <h1>My fxStars</h1>
	                                                <li><a href="">Total Number of Stars: 0</a></li>
							<li><a href="../../register/paypal.php">Add Stars</a></li>
                                                        <li><a href="">Periodic Chart</a></li>
                                        </div>
                                        <br/>
                                        <div class="teamdescription">
                                                <h1>fxStar Transfer</h1>
                                                <li><a href="">Send Stars to a Friend</a></p></li>
						<li><a href="">Request Stars from a Friend</a></p></li>                                        
					</div>
                                        <br/>
                                </div>
                        </div><!-- end sidebar -->
